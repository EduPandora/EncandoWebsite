...
const BrainIcon = ({ className }) => (
  ...
  >
    ...
    <path d="M12 13a2.5 2.5 0 0 0 2.5-2.5v-3a2.5 2.5 0 0 1 2.5-2.5h0A2.5 2.5 0 0 1 19.5 7.5v3A2.5 2.5 0 0 1 17 13Z" />
    <path d="M12 13a2.5 2.5 0 0 1-2.5-2.5v-3a2.5 2.5 0 0 0-2.5-2.5h0A2.5 2.5 0 0 0 4.5 7.5v3A2.5 2.5 0 0 0 7 13Z" />
    <path d="M12 13a2.5 2.5 0 0 0 2.5 2.5v3a2.5 2.5 0 0 1-2.5 2.5h0a2.5 2.5 0 0 1-2.5-2.5v-3A2.5 2.5 0 0 1 9.5 13Z" />
  </svg>
);
    ...
    <section className="bg-[#f9fafb] text-black py-20 md:py-40 lg:py-60">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-1">
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6 md:text-xl">
          <a
            href="https://encando.com/login"
            target="_blank"
            rel="noopener noreferrer"
            className="w-full sm:w-auto inline-block bg-[var(--color-primary)] text-white font-semibold py-3 px-6 rounded-lg hover:bg-[var(--color-primary-light)] transition-all duration-300 transform hover:scale-105 shadow-lg"
          >
            Checkout Encando &#8599;
          </a>
          <a
            ...
            className="w-full sm:w-auto inline-block bg-white text-[var(--color-primary)] font-semibold py-3 px-6 rounded-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg"
          >
            Request a Demo
          </a>
        </div>
        ...
        <a
          ...
          className="w-full sm:w-auto inline-block text-[var(--color-primary)] hover:text-[var(--color-secondary)] transition-all duration-300 transform font-semibold"
        >
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-16 grid gap-8 md:grid-cols-3">
        <ProblemCard
          icon={
            <img
              src={`${process.env.PUBLIC_URL}/assets/images/problem/instructor.png`}
              alt="Tired Instructor"
              className="w-full "
            />
          }
          title="Instructors"
        >
          ...
          <ul className="list-disc list-inside font-semibold">
            ...
            <li>
              Little time left for mentorship, course innovation, or research
            </li>
          </ul>
        </ProblemCard>
        <ProblemCard
          icon={
            <img
              src={`${process.env.PUBLIC_URL}/assets/images/problem/student.png`}
              alt="Tired Student"
              className="w-full"
            />
          }
        ...
        <ProblemCard
          icon={
            <img
              src={`${process.env.PUBLIC_URL}/assets/images/problem/university.png`}
              alt="Tired Institution"
              className="w-full"
            />
          }
          title="Institutions"
        ...
        <div className="w-full md:w-3/4 lg:w-2/3 mx-auto">
          <div className="grid gap-2 md:grid-cols-[25%_75%] lg:gap-16 items-center">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="mt-4 max-w-2xl mx-auto text-lg text-[var(--color-text-primary)]">
                We conducted extensive interviews with educators, TAs, and
                students across institutions as part of our NSF Research and
                I-Corps grant.
              </p>
            </div>
          </div>
      ...
      <div className="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
        <div className="text-center lg:text-left">
          <h2 className="text-3xl md:text-4xl font-extrabold text-[var(--color-text-primary)]">
            Meet{" "}
            <span
              className="text-[var(--color-primary-light)] text-6xl font-extrabold"
          ...
          <p className="mt-4 text-lg text-[var(--color-text-primary)]">
            ...
            Encando is an all-in-one integrated AI platform, designed to reduce
            educators' teaching load and administrative burden, while delivering
            personalized and engaging learning experiences for students -- all
            within a manageable budget for institutions.
          </p>
          <p className="mt-4 text-lg text-[var(--color-text-primary)]">
            ...
            Our platform automates routine TA tasks, provides instant academic
            support, and unlocks deep performance insights. It's the partner you
            need to scale exceptional education.
          </p>
        </div>
...
const instructorFeatures = [
  {
    ...
    description:
      "Effortlessly create comprehensive courses in minutes. Simply upload your syllabus, lecture notes, textbooks, and videos—Encando will thoroughly understand your materials.",
  ...
  },
  {
    ...
    description:
      "Effortlessly grade student assignments with AI. Upload your assignment, generate outlines and solutions, and let Encando’s AI provide instant, customizable grading and feedback.",
  ...
  },
  {
    ...
    description:
      "Streamline project evaluation with automated rubrics. Upload your grading criteria, extract solutions directly from documents, and easily review or adjust grades before exporting results.",
  ...
  },
  {
    ...
    description:
      "Provide instant, reliable answers to your students’ questions any time of day. Encando’s AI-powered assistant supports continuous learning beyond the classroom.",
  ...
  },
  {
    ...
    description:
      "Quickly generate custom quizzes and exercises tailored to each topic, automatically assessing your students’ understanding with precision and efficiency.",
  ...
  },
  {
    ...
    description:
      "Get clear, insightful analytics at a glance. Instantly identify class trends or deep-dive into individual student performance, empowering informed teaching decisions.",
...
const studentFeatures = [
  {
    ...
    description:
      "Gain clarity on assignments whenever you need. Encando’s AI chatbot provides guidance and helps you understand problems deeply without simply revealing answers.",
  ...
  },
  {
    ...
    description:
      "Receive real-time coaching and meaningful feedback on your projects, enabling you to improve your skills and achieve higher scores.",
  ...
  },
  {
    ...
    description:
      "Take charge of your learning with personalized insights. Identify your strengths, tackle weaknesses effectively, track your academic growth, and connect with peers who share your academic interests.",
...
const FeatureScroller = ({ title, description, features, _for }) => {
  ...
  return (
    <div className="mt-20">
      ...
      <h3 className="text-xl md:text-3xl font-extrabold text-[var(--color-text-primary)] text-center">
        {title}
      </h3>
        ...
        <div className="col-span-4 space-y-4 p-3 flex h-[450px] overflow-y-auto flex-col items-start">
          {features.map((feature) => (
            <div
              ...
              className={`shadow-lg p-6 rounded-xl cursor-pointer transition-all duration-600 ${
                activeFeature.id === feature.id
                  ? "border-2 border-[var(--color-primary-light)]"
                  : "bg-[var(--color-surface)] hover:bg-[var(--color-surface)]/50"
              }`}
            >
              <h4
              ...
              <div
                className={`mt-2 text-[var(--color-text-primary)] text-lg transition-all duration-1000 ease-in-out overflow-hidden ${
                  activeFeature.id === feature.id ? "max-h-40" : "max-h-0"
                }`}
              >
          ...
          <div className="relative aspect-video bg-[var(--color-surface)] rounded-xl shadow-2xl overflow-hidden">
            {features.map((feature) => (
              <img
                ...
                src={
                  activeFeature.id === feature.id
                    ? `${feature.imageUrl}?t=${activeFeature.id}`
                    : feature.imageUrl
                }
                alt={feature.title}
      ...
      <div className="lg:hidden mt-8 space-y-6">
        {features.map((feature, index) => (
          <div
            key={feature.id}
            className="bg-[var(--color-surface)] rounded-lg shadow-lg overflow-hidden"
          >
            <img
              src={feature.imageUrl}
              alt={feature.title}
              className="p-6 w-full h-auto object-contain"
            />
            <div className="p-6">
...
const FeaturesSection = () => (
  <section id="features" className="bg-[var(--color-surface)] py-20 sm:py-24">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-y-20">
      <FeatureScroller
        title="Reclaim Your Time. Elevate Your Teaching."
        description="Instructors can now focus on what truly matters: teaching and mentorship."
        features={instructorFeatures}
        _for="instructor"
      />
      <FeatureScroller
        title="Your Personal Guide to Academic Success."
        description="Students enjoy a more engaging and personalized learning journey with like-minded peers."
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center">
        ...
        <p className="mt-4 max-w-3xl mx-auto text-lg text-[var(--color-text-primary)]">
          We're proud to collaborate with leading academic institutions and
          forward-thinking organizations to redefine the learning experience.
        </p>
      </div>
      ...
      <div className="mt-16">
        ...
        <div className="text-center">
          ...
          <div className="mt-6 flex justify-center items-center flex-wrap gap-x-12 gap-y-6 filter">
            ...
            />
            <img
              src="https://www.ttu.edu/brand/images/visual-identity/ttu-wordmark-stack.png"
              alt="TTU Logo"
              className="h-24 w-auto"
            />
            <img
              src="https://upload.wikimedia.org/wikipedia/commons/7/77/University_of_Texas_at_Austin_logo.svg"
              alt="UTMAC Logo"
        ...
        <div className="mt-16 text-center">
          ...
          <div className="mt-6 flex justify-center items-center flex-wrap gap-x-12 gap-y-6 filter ">
            ...
            />
            <img
              src="/assets/logos/NSF-I-Corps.jpg"
...
const testimonials = [
  {
    ...
    quote: (
      <>
        The AI-assisted grading is reasonably
        ...
        <span className="bg-[var(--color-primary)]/10 px-1 rounded font-semibold">
          efficiency, accuracy, and fairness
        </span>{" "}
        in grading assignments and exams.
      </>
    ),
    name: "Bruce L. Tai",
  ...
  },
  {
    ...
    quote: (
      <>
        Encando's AI-assisted report grading made it possible to maintain{" "}
        <span className="text-[var(--color-primary)] font-semibold">
          consistent grading across multiple graders
        </span>
        . It{" "}
        <span className="bg-[var(--color-primary)]/10 px-1 rounded font-semibold">
          saved us time
        </span>{" "}
        and allowed us to focus more on giving{" "}
        <span className="text-[var(--color-primary)] font-semibold">
          meaningful feedback
        </span>{" "}
        to students. I really love the{" "}
        <span className="bg-[var(--color-primary)]/10 px-1 rounded font-semibold">
          Coach Feedback
        </span>{" "}
        feature. It provided well-structured formative guidance and helped
        students{" "}
        <span className="text-[var(--color-primary)] font-semibold">
          improve their work
        </span>{" "}
  ...
  },
  {
    ...
    quote: (
      <>
        Encando helps students{" "}
        <span className="text-[var(--color-primary)] font-semibold">
          understand a topic through examples
        </span>
        ;{" "}
        <span className="bg-[var(--color-primary)]/10 px-1 rounded font-semibold">
          saves time
        </span>{" "}
        when grading structured homework.
      </>
    ),
    name: "Wayne Hung",
  ...
  },
  {
    ...
    quote: (
      <>
        Used the tool for a{" "}
        <span className="text-[var(--color-primary)] font-semibold">
          math heavy mechanics grad class
        </span>{" "}
        with 30+ students and no TA. I used it as a{" "}
        <span className="bg-[var(--color-primary)]/10 px-1 rounded font-semibold">
          unified platform
        </span>{" "}
        for everything from Discussion Boards to grading "mathy" homework. It
        cut my{" "}
        <span className="bg-[var(--color-primary)]/10 px-1 rounded font-semibold">
          grading time to about 1 hour
        </span>{" "}
        and allowed my students to get feedback within a day of submission (not
        just grades but also{" "}
        <span className="text-[var(--color-primary)] font-semibold">
          written feedback and solutions
        </span>
        ). The discussion boards were also heavily used and{" "}
        <span className="text-[var(--color-primary)] font-semibold">
          cut my email traffic heavily
        </span>{" "}
        while being responsive to students. The autogenerated rubric was{" "}
        <span className="text-[var(--color-primary)] font-semibold">
          spot on
        </span>{" "}
        and the grading of handwritten homeworks was{" "}
        <span className="bg-[var(--color-primary)]/10 px-1 rounded font-semibold">
          unbelievably good
        </span>
        . Grading was consistent across all students and the interface was
        remarkably easy and intuitive. I am planning to use this for all my
        upcoming classes for sure.
      </>
    ),
    name: "Arun Srinivasa",
...
const TestimonialCard = ({ testimonial }) => (
  <div className="group relative bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 flex flex-col h-full">
    ...
    <blockquote
      className={`mt-3 sm:mt-4 text-[var(--color-text-primary)] ${
        testimonial.textSize || "text-base md:text-lg"
...
const TestimonialsSection = () => {
  ...
  return (
    <section
      id="testimonials"
      className="relative bg-gradient-to-b from-[#f8fafc] to-[#f1f5f9] py-20 sm:py-28 overflow-hidden"
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 sm:mb-12 md:mb-16">
          ...
          <p className="mt-3 sm:mt-4 max-w-2xl mx-auto text-base sm:text-lg text-gray-600 px-4">
            Hear from professors who are transforming their teaching experience
            with Encando.
          </p>
        </div>
        ...
        >
          ...
          <button
            onClick={goToPrev}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-2 sm:-translate-x-4 lg:-translate-x-6 z-10 w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-full shadow-lg hover:shadow-xl flex items-center justify-center text-[var(--color-primary)] hover:bg-[var(--color-primary)] hover:text-white transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] focus:ring-offset-2"
          ...
          <button
            onClick={goToNext}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-2 sm:translate-x-4 lg:translate-x-6 z-10 w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-full shadow-lg hover:shadow-xl flex items-center justify-center text-[var(--color-primary)] hover:bg-[var(--color-primary)] hover:text-white transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] focus:ring-offset-2"
          ...
          <div className="overflow-hidden mx-6 sm:mx-10 lg:mx-14">
            <div
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center lg:text-left">
          ...
          <p className="mt-4 text-lg leading-6 text-[var(--color-text-primary)]">
            See how Encando's AI can empower your institution, engage your
            students, and unlock limitless potential. Schedule a brief meeting
            with our team today.
          </p>
          ...
          <div className="mt-8 flex items-center w-full justify-center gap-4">
            <div className="flex justify-center items-center ">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-[var(--color-primary)] text-white font-semibold py-3 px-6 rounded-lg hover:bg-[var(--color-primary-light)] transition-colors"
              >
                Request a Demo
              </a>
            </div>
            ...
            <div className="flex justify-center items-center gap-2 w-full sm:w-auto">
              <a
                href="https://join.slack.com/t/encando/shared_invite/zt-362lnbhcm-UFwOVxwsDbj27SNOPpUBJg"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex bg-[var(--color-surface)] items-center gap-2 rounded-lg py-3 px-6 transition-all duration-300 transform hover:scale-105 shadow-lg"
              >
                <svg
                  className="nav-icon slack-icon"
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
                >
                  <path
                    d="M5.042 15.165a2.528 2.528 0 0 1-2.52 2.523A2.528 2.528 0 0 1 0 15.165a2.528 2.528 0 0 1 2.522-2.52h2.52v2.52z"
                    fill="#E01E5A"
                  />
                  <path
                    d="M6.313 15.165a2.528 2.528 0 0 1 2.521-2.52 2.528 2.528 0 0 1 2.521 2.52v6.313A2.528 2.528 0 0 1 8.834 24a2.528 2.528 0 0 1-2.521-2.522v-6.313z"
                    fill="#E01E5A"
                  />
                  <path
