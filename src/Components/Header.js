            ...
            <div className="header-content">
                ...
                <nav>
                    <div className={`nav-buttons-container ${isMobileMenuOpen ? 'mobile-open' : ''}`}>
                        ...
                        <Link to="/product" className="inline-block text-black font-semibold py-3 px-6 rounded-lg hover:bg-[var(--color-primary)] hover:text-white transition-all duration-300 transform hover:scale-105 hover:shadow-lg" onClick={closeMobileMenu}>
                            Product
                        </Link>
